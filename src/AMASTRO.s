...
`FAT entry: RETPFL`:
                ...
                .PUBLIC `FAT entry: YNTEST`, `FAT entry: ABACK`, `FAT entry: KEYMENU`, `FAT entry: APRMT`, `FAT entry: ARCLINT`, `FAT entry: CLASP`, `FAT entry: RETPFL`
...
;           .con 0x37B  ;  GONC -11    LB_A8CF       A8CF
           gonc LB_B8CF
LB_B8E1:   .con 0x0CE  ;  C=B         ALL           
           .con 0x03C  ;  RCR         3             
           .con 0x08D  ;  GOLNC       PTBYTA        2323          ; HP41 SYSTEM ROM 2
           .con 0x08E  ;                            


LB_B8EF:   .con 0x0C9  ;  GOLC        6532          
           .con 0x197  ;                            
...
;           .con 0x013  ;  GONC +02    LB_A942       A942
           gonc LB_B942
           .con 0x208  ;  ST=1        2             
LB_B942:   .con 0x3D8  ;  CSTEX                     
           .con 0x0BC  ;  RCR         5             
           .con 0x3A8  ;  REGN=C      (14)d         
LB_B945:   .con 0x198  ;  C=M                       
           .con 0x266  ;  C=C-1       S&X           
           .con 0x360  ;  RTNC                      
           .con 0x17C  ;  RCR         6             
           .con 0x10E  ;  A=C         ALL           
...
;           .con 0x33B  ;  GONC -19    LB_A945       A945
           gonc LB_B945
LB_B95F:   .con 0x398  ;  C=ST                      
           .con 0x3C4  ;  CLRST                     
;           .con 0x023  ;  GONC +04    LB_A965       A965
           gonc LB_B965
LB_B962:   .con 0x398  ;  C=ST                      
           .con 0x3C4  ;  CLRST                     
           .con 0x388  ;  ST=1        0             
LB_B965:   .con 0x39C  ;  PT=         0             
           .con 0x058  ;  G=C                       
           .con 0x0A6  ;  ACEX        S&X           
           .con 0x2BC  ;  RCR         7             
           .con 0x1B0  ;  C=STK                     
...
;           .con 0x017  ;  GOC  +02    LB_A97D       A97D
           goc LB_B97D
           .con 0x308  ;  ST=1        1             
LB_B97D:   .con 0x15C  ;  PT=         6             
           .con 0x210  ;  LC          8             
           .con 0x04A  ;  C=0         R<-           
           .con 0x15C  ;  PT=         6             
LB_B981:   .con 0x330  ;  CXISA                     
           .con 0x366  ;  ?A#C        S&X           
...
;           .con 0x013  ;  GONC +02    LB_A998       A998
           gonc LB_B998
LB_B997:   .con 0x146  ;  A=A+C       S&X           
LB_B998:   .con 0x03C  ;  RCR         3             
           .con 0x0A6  ;  ACEX        S&X           
           .con 0x01C  ;  PT=         3             
           .con 0x0D0  ;  LC          3             
           .con 0x33C  ;  RCR         1             
;           .con 0x03B  ;  GONC +07    LB_A9A4       A9A4
           gonc LB_B9A4
LB_B99E:   .con 0x17C  ;  RCR         6             
           .con 0x39C  ;  PT=         0             
           .con 0x102  ;  A=C         @R            
           .con 0x0BC  ;  RCR         5             
           .con 0x0A6  ;  ACEX        S&X           
           .con 0x37C  ;  RCR         12            
LB_B9A4:   .con 0x1B0  ;  C=STK                     
           .con 0x23A  ;  C=C+1       M             
           .con 0x38C  ;  ST=1?       0             
;           .con 0x017  ;  GOC  +02    LB_A9A9       A9A9
           goc LB_B9A9
           .con 0x170  ;  STK=C                     
LB_B9A9:   .con 0x39C  ;  PT=         0             
           .con 0x0D8  ;  CGEX                      
           .con 0x358  ;  ST=C                      
           .con 0x0D8  ;  CGEX                      
           .con 0x035  ;  GOLNC       0C0D          
           .con 0x032  ;                            
LB_B9AF:   .con 0x3C1  ;  GSUBNC      CLLCDE        2CF0          ; HP41 SYSTEM ROM 2
           .con 0x0B0  ;                            
...
LB_BD0D:   .con 0x3DD  ;  GSUBNC      LEFTJ         2BF7          ; HP41 SYSTEM ROM 2
           .con 0x0AC  ;                            
           .con 0x108  ;  ST=1        8             
           .con 0x201  ;  GSUBNC      MSG105        1C80          ; HP41 SYSTEM ROM 1
           .con 0x070  ;                            
